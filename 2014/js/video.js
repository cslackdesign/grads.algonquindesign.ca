...
$('.btn-open').magnificPopup({
  items: {
      src: '<div class="white-popup"><iframe class="vid" src="//player.vimeo.com/video/85752664?autoplay=1" width="500" height="281" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe><h2>Welcome to Level 14</h2></div>',
      type: 'inline'
  },
  closeBtnInside: true
});
